...
<html >
<head>
<meta http-equiv="refresh" content="2;URL=${pageContext.request.contextPath}/mainController/tomain"></span> 
...
<div class="content-wrapper">
	<div class="content-main animate">
		<div class="container">
			<h1 class="font-size-90">博客!</h1>
			<h2 class="opacity-60">欢迎进入个人博客系统首页</h2>
		    <h2 class="opacity-60">三秒钟后即将抵达战场</h2>
		</div>
		<!--end container-->
	</div>
	<!--end content-main-->
