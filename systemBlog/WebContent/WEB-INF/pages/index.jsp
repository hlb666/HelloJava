 ...
 <!-- -----------------------------------文章区-------------------------------- -->     
      ...
      <article class="excerpt excerpt-1"><a class="focus" href="${pageContext.request.contextPath}/mainController/toarticle" title=""><img class="thumb" data-original="${lists.images }" src="${lists.images }" alt=""></a>     
        ...
        <p class="meta">
          ...
          <span class="views"><i class="glyphicon glyphicon-eye-open"></i>${lists.numpeople }</span> <a class="comment" href="${pageContext.request.contextPath}/mainController/toarticle"><i class="glyphicon glyphicon-comment"></i> ${lists.numpeople }</a></p>
