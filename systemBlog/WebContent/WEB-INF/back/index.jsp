  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      <ul class="nav nav-sidebar">
        <li class="active"><a href="${pageContext.request.contextPath}/backController/index">报告</a></li>
      </ul>
      <ul class="nav nav-sidebar">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="row placeholders">
        ...
        <div class="col-xs-6 col-sm-3 placeholder">
          ...
          <input type="hidden" id="result" name="zhi" value="${MSG}"/>
          </div>
        <div class="col-xs-6 col-sm-3 placeholder">
          <h4>友链</h4>
          <span class="text-muted">0 条</span> </div>
        ...
        <div class="modal-body">
          <table class="table" style="margin-bottom:0px;">
            ...
            <tbody>
              <tr>
                <td wdith="20%">用户名:</td>
                <td width="80%"><input type="text" value="${username}" class="form-control" name="truename" maxlength="10" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">注册编号:</td>
                <td width="80%"><input type="text" value="${uid}" class="form-control" name="username" maxlength="10" autocomplete="off" /></td>
              </tr>
              <tr>
                <td wdith="20%">剩余积分:</td>
                <td width="80%"><input type="text" value="${integral}" class="form-control" name="usertel" maxlength="13" autocomplete="off" /></td>
              </tr>
            </tbody>
            <tfoot>
              <tr></tr>
