...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="${pageContext.request.contextPath}/backOperateController/toUpdataArticle" method="post" class="add-article-form">
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<input type="text" class="form-control" placeholder="请输入关键字" value="${article.keyword}" name="keywords" autocomplete="off">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<textarea class="form-control" name="describe" autocomplete="off">${article.description}</textarea>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  ...
                  <li>
                    <label>
                      <input name="type" type="radio" value="其他">
                                                               其他 <em class="hidden-md"></em></label>
                  </li>
                </ul>
              </div>
            </div>        
