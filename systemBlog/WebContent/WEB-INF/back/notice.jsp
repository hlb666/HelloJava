...
<section class="container-fluid">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      <ul class="nav nav-sidebar">
       ...
       <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/backController/notice">管理公告</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="${pageContext.request.contextPath}/backOperateController/deleteAffiches" method="post" >
        <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
          <li><a href="${pageContext.request.contextPath}/backController/add-notice">增加公告</a></li>
        </ol>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
            <c:forEach items="${affiches }" var="list">
              <tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="${list.id }" /></td>
                <td class="article-title">${list.content }</td>
                <td>${list.date }</td>
                <td><a href="${pageContext.request.contextPath}/backOperateController/deleteAffiche?id=${list.id}">删除</a></td>
              </tr>
             </c:forEach>
