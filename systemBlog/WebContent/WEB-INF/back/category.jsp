...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
           <form role="form" action="${pageContext.request.contextPath}/fileUploadController/uploadFile" enctype="multipart/form-data" method="post">
       <table class="table table-striped" border= '1px' cellpadding="10" cellspacing="0" align="center" >
         <tr >
          <th>上传用户</th>
          <th>上传文件</th>
         </tr>
         ...
         <tr class='tr'>
          <td colspan="2" align="center"><input class="btn btn-success" type="submit" value="提交"></td>
         </tr>
         <tr class='tr'>
          <td colspan="2" align="center"><a href="GetAllEmpServlet"><input class="btn btn-warning" type="button" value="返回"></a></td>
         </tr>
       </table>           
    </form>     
      </div>
