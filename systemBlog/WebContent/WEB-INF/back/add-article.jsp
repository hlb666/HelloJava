...
<section class="container-fluid">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      <ul class="nav nav-sidebar">
       ...
       <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/backController/addarticle">发布博客</a></li>
      ...
      <ul class="nav nav-sidebar">
        <li><a class="dropdown-toggle" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">用户</a>
          <ul class="dropdown-menu" aria-labelledby="userMenu">
            ...
            <li><a href="${pageContext.request.contextPath}/backController/manage-user.html">管理用户</a></li>
           </ul>
        </li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      ...
      <div class="row">
        <form action="${pageContext.request.contextPath}/backOperateController/insertBlog" method="post" class="add-article-form cmxform" >
          <div class="col-md-9">
            ...
            <!-- 第二部分  <script id="article-content" name="content" type="text/plain"></script>-->
            <div class="form-group">
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  <li>
                    <label>
                      <input name="type" type="radio" value="前端程序" checked>
                                                           前端程序<em class="hidden-md"></em></label>
                  </li>
                  <li>
                    <label>
                      <input name="type" type="radio" value="后端程序">
                                                            后端程序 <em class="hidden-md"></em></label>
                  </li>
                  <li>
                    <label>
                      <input name="type" type="radio" value="授人以渔">
                                                              授人以渔 <em class="hidden-md"></em></label>
                  </li>
                  <li>
                    <label>
                      <input name="type" type="radio" value="管理系统">
                                                               管理系统 <em class="hidden-md"></em></label>
                  </li>
                  <li>
                    <label>
                      <input name="type" type="radio" value="程序人生">
                                                               程序人生 <em class="hidden-md"></em></label>
                  </li>
                </ul>
              </div>
            </div>        
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <!--  
                <input type="text" class="form-control" placeholder="选择标签" name="tags" autocomplete="off">
                <span class="prompt-text">多个标签请用英文逗号,隔开</span> </div>
                -->
                <select name="lable" id="tags" autocomplete="off" style="width:100% ">
			        ...
			        <option value="MobileInter">MobileInter</option>
			    </select>         
            </div>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <p><label>发布于：</label><span class="article-time-display"><input style="border: none;width:160px" type="text" name ="date" id="clock" value = ""/></span></p>
              </div>
              <div class="add-article-box-footer">
