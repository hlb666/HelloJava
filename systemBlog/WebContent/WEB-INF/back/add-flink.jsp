  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      <ul class="nav nav-sidebar">
        ...
        <ul class="nav nav-sidebar">
        <li><a href="${pageContext.request.contextPath}/backController/article">博客</a></li>
        <li><a href="${pageContext.request.contextPath}/backController/notice">公告</a></li>
      ...
      <ul class="nav nav-sidebar">
         ...
         <li class="active"><a href="${pageContext.request.contextPath}/backController/flink">友情链接</a></li>
      </ul>
      <ul class="nav nav-sidebar">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="${pageContext.request.contextPath}/backOperateController/addLink" method="post" class="add-flink-form" autocomplete="off" draggable="false">
          <div class="col-md-9">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <span class="prompt-text">例如：恋志技术博客</span> </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>WEB地址</span></h2>
              <div class="add-article-box-content">
                <input type="text" id="flink-url" name="address" class="form-control" placeholder="在此处输入URL地址" required autocomplete="off">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <textarea class="form-control" name="descript" autocomplete="off"></textarea>
