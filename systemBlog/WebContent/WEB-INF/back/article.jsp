...
<section class="container-fluid">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li class="active"><a href="${pageContext.request.contextPath}/backController/article">管理博客</a></li>
 ...
 <!-- =================内容区域--------------------------------------------- --> 
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="${pageContext.request.contextPath}/backOperateController/deleteArticles" method="post" >
        <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
          <li><a href="${pageContext.request.contextPath}/backController/addarticle">增加文章</a></li>
        </ol>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <c:forEach items="${list}" var="lists">           
              <tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="${lists.id}" /></td>
                <td class="article-title">${lists.title }</td>
                <td>${lists.type}</td>
                <td class="hidden-sm">${lists.lable }</td>
                <td class="hidden-sm">${lists.numpeople }</td>
                <td>${lists.date}</td>
                <td><a href="${pageContext.request.contextPath}/backOperateController/updataArticle?id=${lists.id}">修改</a> 
                <a href="${pageContext.request.contextPath}/backOperateController/deleteArticle?id=${lists.id}">删除</a></td>
              </tr>
             </c:forEach> 
            </tbody>
          </table>
