...
<div class="container">
  ...
  <form action="${pageContext.request.contextPath}/bacLoginController/login" method="post" autocomplete="off" class="form-signin">
    ...
    <a href="${pageContext.request.contextPath}/backController/main"><button class="btn btn-lg btn-primary btn-block" type="submit" id="signinSubmit">登录</button></a>
  </form>
  <div class="footer">
    <p><a href="${pageContext.request.contextPath}/backController/index" data-toggle="tooltip" data-placement="left" title="不知道自己在哪?">回到后台 →</a></p>
  </div>
</div>
