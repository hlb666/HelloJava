...
<section class="container-fluid">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      <ul class="nav nav-sidebar">
       ...
       <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="${pageContext.request.contextPath}/backController/add-notice">发布公告</a></li>
      </ul>
      <ul class="nav nav-sidebar">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="${pageContext.request.contextPath}/backOperateController/addAffiche" method="post" class="add-article-form">
          <div class="col-md-9">
            <h1 class="page-header">撰写新公告</h1>
            <div class="form-group">
              <label for="article-title" class="sr-only">miaoshu</label>
              <input type="text" id="article-title" name="title"
                style="background-color: white; text-align: center;"
               class="form-control" text-align="centre" disabled="disabled" 
                placeholder="请在下方填写公告内容"  autofocus autocomplete="off">
            </div>
            <div class="form-group">        
              <textarea id="article-content" name="content" class="form-control"></textarea> 
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span style="text-align: center;">选择时间</span></h2>
              <div class="add-article-box-content">
              	<input type="text" class="form-control" id="datepicker" name="date" autocomplete="off">
                <span class="prompt-text">选择公告发布的时间</span>
              </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>描述</span></h2>
              <div class="add-article-box-content">
                <span class="prompt-text">请文明发布公告！不得违反中国人民共和国现有法律！----若有相关事情，后果自负！！！</span>
              </div>
            </div>
          </div>
          <div class="col-md-3">
