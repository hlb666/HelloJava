  ...
  <div class="row">
   ...
   <ul class="nav nav-sidebar">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="${pageContext.request.contextPath}/backOperateController/deleteLinks" method="post" >
        <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
          <li><a href="${pageContext.request.contextPath}/backController/add-flink">增加友情链接</a></li>
        </ol>
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <c:forEach items="${links}" var="links">
              ...
              <tr>
                <td><input type="checkbox" class="input-control" name="checkbox[]" value="${links.id}" /></td>
                <td class="article-title">${links.title }</td>
                <td>${links.address }</td>
                <td><a href="${pageContext.request.contextPath}/backOperateController/deleteLink?id=${links.id}">删除</a></td>
              </tr>
