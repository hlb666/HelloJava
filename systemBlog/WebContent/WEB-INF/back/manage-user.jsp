          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                ...
                <th><span class="glyphicon glyphicon-pushpin"></span> <span class="visible-lg">身份</span></th>
            ...
            <c:forEach items="${list }" var="list">   
              <tr>
                ...
                <td>${list.username }</td>
                <td>${list.username }</td>
                <c:if test="${list.identify ==1}">
                  <td>超级管理员</td>  
                </c:if>     
                <c:if test="${list.identify ==0}">
                <td>用户</td>  
              </c:if>                       
                <td><a href="${pageContext.request.contextPath}/backOperateController/deleteUser?id=${list.id}" name="delete">删除</a> <a href="#">禁用</a></td>
              </tr>
            </c:forEach>
            </tbody>
          </table>
