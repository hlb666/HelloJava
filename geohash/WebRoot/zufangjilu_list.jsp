...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="zufangjiluList.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.fangyuanbianhao}</td>    <td>${u.fangyuanmingcheng}</td>    <td>${u.faburen}</td>    <td>${u.yuezujin}</td>    <td>${u.yuyuekanfang}</td>        <td>${u.chengzuren}</td>    <td>${u.fangdonghuifu}</td>    <td align='center'>${u.issh} <input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=zufangjilu'"/></td>
		 ...
		 <c:if test="${page.page>1}">
              <a href="zufangjiluList.do?page=1" >首页</a>
             <a href="zufangjiluList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="zufangjiluList.do?page=${page.page+1 }">下一页</a>
			<a href="zufangjiluList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
