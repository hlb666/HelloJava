...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="fangyuanxinxiList.do" name="myform" method="post">
		 ...
		 <c:if test="${page.page>1}">
              <a href="fangyuanxinxiList.do?page=1" >首页</a>
             <a href="fangyuanxinxiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="fangyuanxinxiList.do?page=${page.page+1 }">下一页</a>
			<a href="fangyuanxinxiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
