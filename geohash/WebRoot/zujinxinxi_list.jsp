...
-->
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="zujinxinxiList.do" name="myform" method="post">
    ...
    <td align='center'>${u.issh} <input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=zujinxinxi'"/></td>
		 ...
		 <%
			String sql="select * from zujinxinxi where 1=1 ";
...
while(RS_result.next()){
		...
		共计月租金:<%=yuezujinz%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="zujinxinxiList.do?page=1" >首页</a>
             <a href="zujinxinxiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="zujinxinxiList.do?page=${page.page+1 }">下一页</a>
			<a href="zujinxinxiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
