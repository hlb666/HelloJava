...
body,td,th {
    ...
    <td  width='80' align='center'>租房合同</td>
    ...
    <td align='center'><a href="zufanghetong_add.jsp?id=${u.id }">租房合同</a></td>
    <td align='center'>${u.issh} <input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=zufangjilu'"/></td>
                              ...
                              <td align="center"><a href="doUpdateZufangjilulb.do?id=${u.id }">回复</a>  <a href="deleteZufangjilu.do?id=${u.id }"
