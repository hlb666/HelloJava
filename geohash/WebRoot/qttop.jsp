...
function checklog()
{
  ...
  <!-- end ntbg-->
  <div class="top">
    <div class="logo"><img src="qtimages/hsglogo.gif" alt="" > &nbsp;GeoHash应用租房系统实例</div>
    <!-- end logo-->
    <div class="search">
  ...
  <div  class="navgrp">
    <ul class="nav" id="nav">
	  ...
	  <li><a >新闻公告</a>
      <div id="navChild"> <a href="xwtzList.do?lb=站内新闻">站内新闻</a> <a href="xwtzList.do?lb=行业资讯">行业资讯</a> </div>
      </li>
      <li>
      <a href="fyxxList.do">房源展示</a>
      <div id="navChild">
       <a href="ShowAll.jsp">全房源展示图</a>
       </div>
      </li>
	  <li>
	  <a>在线留言</a>
      <div id="navChild">
       <a href="lyb.jsp">我要留言</a>
...
while(RS_resultbht.next())
{
		...
		%>
		<li style="background:url(<%=RS_resultbht.getString("shouyetupian")%>) 50% 0 no-repeat;"></li>
		<%
		}
		%>
	</ul>
