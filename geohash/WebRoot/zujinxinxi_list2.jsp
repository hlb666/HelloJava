...
-->
    ...
    <a href="zhifu.jsp?id=${u.id }&biao=zujinxinxi">支付</a>
    </c:if></td>
    <td align='center'>${u.issh} </td>
                              <td align="center"> ${u.addtime } </td>
                              <td align="center"> <a href="zujinxinxiDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <%
			String sql="select * from zujinxinxi where chengzuren='"+(String)request.getSession().getAttribute("username")+"'  ";
